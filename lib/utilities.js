define(['./request'], function(Request) {
    ...
    function requestWithDataAndPollFun(method, uriTemplate, uriVars, headers, pollingInterval, stoppingCondition) {
        return function() {
            ...
            (requestWithDataFun(method, uriTemplate, uriVars, headers)).apply(this, args)

                .done(function(data, headers) {
                    var pollRequestFun = requestFun('GET', headers.Location);
                    poll(stoppingCondition, deferred, pollingInterval, pollRequestFun);
                })
    ...
    /**
     * Repeatedly poll for success until the stopping condition
     * is met
     *
     * @private
     ...
     * @param {function} getStatusFun
     */
    function poll(stoppingCondition, deferred, pollingInterval, pollRequestFun) {
